(eval-when (:compile-toplevel :load-toplevel :execute)(unless (find-package "defun.py")(make-package "defun.py" :use '("COMMON-LISP"))) ) (in-package "defun.py")
(use-package "builtins")(DEFUN |test| (|x|  ) (RETURN-FROM |test| (+ |x| 1)))

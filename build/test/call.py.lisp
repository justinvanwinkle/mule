(eval-when (:compile-toplevel :load-toplevel :execute)(unless (find-package "call.py")(make-package "call.py" :use '("COMMON-LISP"))) ) (in-package "call.py")
(use-package "builtins")(DEFUN |foo| (  ) (RETURN-FROM |foo| 1))

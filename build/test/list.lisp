...
(use-package "builtins")(DEFPARAMETER |x| (|list| (list ))) (DEFPARAMETER |y| (|list| (list 9))) (DEFPARAMETER |z| (|list| (list 1 2 3))) (|ASSERT| (EQUALP |z| (|list| (list 1 2 3))) ) (|ASSERT| (EQUALP (|getitem| |y| 1) 9) )
